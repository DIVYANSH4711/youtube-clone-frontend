...
export default function Register() {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 bg-black flex items-center justify-center p-6">
        <div className="max-w-md w-full space-y-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full bg-cyan-900 hover:bg-blue-700 text-white py-2 rounded-md" disabled={loading}>
      ...
      <div className="hidden md:flex flex-1 bg-zinc-300 items-center justify-center p-10">
        <h1 className="text-3xl font-extrabold text-zinc-900">Join Us & Start Streaming!</h1>
      </div>
    </div>
  );
}
